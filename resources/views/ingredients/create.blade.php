...
@section('content')
  <div class="app-title">
    <div>
      <h1><i class="fa fa-plus"></i> Add Ingredient</h1>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          <form action="{{ route('ingredients.store') }}" method="POST" class="js-controlled-form">
            @csrf
            @include('ingredients.partials._form-fields')
